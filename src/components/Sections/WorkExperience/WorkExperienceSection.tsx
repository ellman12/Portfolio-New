    ...
    return (
        <Section icon={<WorkIcon/>} title="Work Experience">
            ...
            <Timeline sx={{[`& .${timelineOppositeContentClasses.root}`]: {flex: 0.28}}}>
                <WorkTimelineItem startDate="May 2022" endDate="May 2023" title="Software Engineer Intern — Daktronics" color="primary">
                ...
                <WorkTimelineItem startDate="June 2023" endDate="Present" title="Software Engineer  KBR" lastItem={true} color="success">
